...
PDFS = {
    ...
    # Güven Çelik Halat'ın DIEPA · OLIVEIRA · UNION · DRAKO ürün föyleri
    # (2026-08-29'da guvencelikhalat.com.tr'den indirildi). Her föy kendi
    # başına bir yaprak destesidir: 1. sayfa genel bakış, kalanı teknik tablo.
    # MB/MX/ML serilerinde tablo ailenin tamamını taşır ve her ürünün PDF'inde
    # ayrıca basılıdır; bu yüzden her ürün KENDİ föyüne bağlanır — böylece
    # açılan yaprakta o ürünün RCN/dolgu faktörü kutusu da görünür.
    "diepa_x53": "Diğer kataloglar/DIEPA-X-53-X-50.pdf",
    "diepa_pz299": "Diğer kataloglar/DIEPA-PZ-299-Z-299.pdf",
    "diepa_mx4": "Diğer kataloglar/DIEPA-MX-4.pdf",
    "diepa_mx5": "Diğer kataloglar/DIEPA-MX-5.pdf",
    "diepa_mx6": "Diğer kataloglar/DIEPA-MX-6.pdf",
    "diepa_mb4": "Diğer kataloglar/DIEPA-MB-4.pdf",
    "diepa_mb5": "Diğer kataloglar/DIEPA-MB-5.pdf",
    "diepa_mb6": "Diğer kataloglar/DIEPA-MB-6.pdf",
    "diepa_mb7": "Diğer kataloglar/DIEPA-MB-7.pdf",
    "diepa_ml4": "Diğer kataloglar/DIEPA-ML-4.pdf",
    "diepa_ml5": "Diğer kataloglar/DIEPA-ML-5.pdf",
    "diepa_b55": "Diğer kataloglar/DIEPA-B-55-1.pdf",
    "diepa_c45": "Diğer kataloglar/DIEPA-C-45-1.pdf",
    "diepa_k43": "Diğer kataloglar/DIEPA-K-43-1.pdf",
    "diepa_s67wp": "Diğer kataloglar/DIEPA-S-67-WP.pdf",
    "oliveira_nr_maxipact": "Diğer kataloglar/OLIVEIRA-NR-MAXIPACT-PPI-urun.pdf",
    "oliveira_nr15_maxilift": "Diğer kataloglar/OLIVEIRA-NR15-MAXILIFT-PPI-urun.pdf",
    "oliveira_towerlift": "Diğer kataloglar/OLIVEIRA-TOWERLIFT-15-urun.pdf",
    "oliveira_lp5": "Diğer kataloglar/OLIVEIRA-LP-5.pdf",
    "oliveira_super_yellow": "Diğer kataloglar/OLIVEIRA-SUPER-YELLOW-FIN-KENDIR-OZLU-urun.pdf",
    "oliveira_zincal": "Diğer kataloglar/OLIVEIRA-ZINCAL-COMPACT-urun.pdf",
    "union_powermax": "Diğer kataloglar/UNION-POWERMAX-PFV-urun.pdf",
    "union_6_strand": "Diğer kataloglar/UNION-6-STRAND-PFV-urun.pdf",
    "union_tuf_max": "Diğer kataloglar/UNION-TUF-MAX-urun.pdf",
    "union_flex_x9": "Diğer kataloglar/UNION-FLEX-X-9-urun.pdf",
    "union_3xk7": "Diğer kataloglar/UNION-3xK7-urun.pdf",
    "drako_300t": "Diğer kataloglar/DRAKO-300-T-urun.pdf",
    "drako_250t": "Diğer kataloglar/DRAKO-250-T-urun.pdf",
    "drako_210tf": "Diğer kataloglar/DRAKO-210-TF.pdf",
    "drako_210tfs": "Diğer kataloglar/DRAKO-210-TFS.pdf",
    "drako_8x19_s_fc": "Diğer kataloglar/DRAKO-8x19-S-FC.pdf",
    "drako_8x19_w_fc": "Diğer kataloglar/DRAKO-8x19-W-FC.pdf",
    "drako_8x25_f_fc": "Diğer kataloglar/DRAKO-8x25-F-FC.pdf",
...
MANUAL = [
    ...
    ("rope", "DIEPA", "6 demetli kompakt (Z 299)", "diepa_z_299.json", "diepa_pz299", [0, 1, 2], "s.1-3",
     "DIEPA 6 demetli kompakt (Z 299) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "8 demetli (MX4)", "diepa_mx_4.json", "diepa_mx4", [0, 1, 2, 3], "s.1-4",
     "DIEPA 8 demetli (MX4) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "8 demetli kompakt (MX5)", "diepa_mx_5.json", "diepa_mx5", [0, 1, 2, 3], "s.1-4",
     "DIEPA 8 demetli kompakt (MX5) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "8 demetli kompakt (MX6)", "diepa_mx_6.json", "diepa_mx6", [0, 1, 2, 3], "s.1-4",
     "DIEPA 8 demetli kompakt (MX6) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "15 demetli (MB4)", "diepa_mb_4.json", "diepa_mb4", [0, 1, 2, 3], "s.1-4",
     "DIEPA 15 demetli (MB4) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "15 demetli kompakt (MB5)", "diepa_mb_5.json", "diepa_mb5", [0, 1, 2, 3], "s.1-4",
     "DIEPA 15 demetli kompakt (MB5) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "15 demetli kompakt (MB6)", "diepa_mb_6.json", "diepa_mb6", [0, 1, 2, 3], "s.1-4",
     "DIEPA 15 demetli kompakt (MB6) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "15 demetli kompakt (MB7)", "diepa_mb_7.json", "diepa_mb7", [0, 1, 2, 3], "s.1-4",
     "DIEPA 15 demetli kompakt (MB7) — genel bakış ve çelik halat teknik tabloları"),
    ("rope", "DIEPA", "10 demetli (ML4)", "diepa_ml_4.json", "diepa_ml4", [0, 1, 2, 3], "s.1-4",
    ...
    ("rope", "DIEPA", "15 demetli (K 43)", "diepa_k_43.json", "diepa_k43", [0, 1], "s.1-2",
     "DIEPA 15 demetli (K 43) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DIEPA", "Plastik dolgulu galvaniz (S 67 WP)", "diepa_s_67_wp.json", "diepa_s67wp", [0], "s.1",
     "DIEPA Plastik dolgulu galvaniz (S 67 WP) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "OLIVEIRA", "37xK7/37xK19/37xK26 (NR Maxipact PPI)", "oliveira_nr_maxipact_ppi.json", "oliveira_nr_maxipact", [0, 1], "s.1-2",
     "OLIVEIRA 37xK7/37xK19/37xK26 (NR Maxipact PPI) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "OLIVEIRA", "31xK7/34xK7 (NR15 Maxilift PPI)", "oliveira_nr15_maxilift_ppi.json", "oliveira_nr15_maxilift", [0, 1], "s.1-2",
     "OLIVEIRA 31xK7/34xK7 (NR15 Maxilift PPI) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "OLIVEIRA", "27x7/31x7 (Towerlift 15)", "oliveira_towerlift_15.json", "oliveira_towerlift", [0, 1], "s.1-2",
     "OLIVEIRA 27x7/31x7 (Towerlift 15) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "OLIVEIRA", "5xK12/5xK19/5xK26/5xK31 (LP 5)", "oliveira_lp_5.json", "oliveira_lp5", [0, 1], "s.1-2",
     "OLIVEIRA 5xK12/5xK19/5xK26/5xK31 (LP 5) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "OLIVEIRA", "6xK19 S · 6xK26 WS (Super Yellow Fin)", "oliveira_super_yellow_fin.json", "oliveira_super_yellow", [0, 1], "s.1-2",
     "OLIVEIRA 6xK19 S · 6xK26 WS (Super Yellow Fin) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "OLIVEIRA", "6xK26 WS (Zincal Compact, kendir özlü)", "oliveira_zincal_compact_fc.json", "oliveira_zincal", [0, 1], "s.1-2",
     "OLIVEIRA 6xK26 WS (Zincal Compact, kendir özlü) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "OLIVEIRA", "6xK26 WS (Zincal Compact, çelik özlü)", "oliveira_zincal_compact_iwrc.json", "oliveira_zincal", [0, 1], "s.1-2",
     "OLIVEIRA 6xK26 WS (Zincal Compact, çelik özlü) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "UNION", "8 demetli plastik kaplı (Powermax PFV)", "union_powermax_pfv.json", "union_powermax", [0, 1], "s.1-2",
     "UNION 8 demetli plastik kaplı (Powermax PFV) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "UNION", "6 demetli plastik kaplı (6-Strand PFV)", "union_6_strand_pfv.json", "union_6_strand", [0, 1], "s.1-2",
     "UNION 6 demetli plastik kaplı (6-Strand PFV) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "UNION", "Çift kaplamalı özlü (Tuf-Max)", "union_tuf_max.json", "union_tuf_max", [0, 1], "s.1-2",
     "UNION Çift kaplamalı özlü (Tuf-Max) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "UNION", "9 demetli dövme (Flex X-9)", "union_flex_x_9.json", "union_flex_x9", [0], "s.1",
     "UNION 9 demetli dövme (Flex X-9) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "UNION", "3xK7 dövme (3xK7)", "union_3xk7.json", "union_3xk7", [0], "s.1",
     "UNION 3xK7 dövme (3xK7) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "9 demetli (300 T)", "drako_300_t.json", "drako_300t", [0], "s.1",
     "DRAKO 9 demetli (300 T) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x19 W (250 T)", "drako_250_t.json", "drako_250t", [0], "s.1",
     "DRAKO 8x19 W (250 T) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x19 W (210 TF)", "drako_210_tf.json", "drako_210tf", [0], "s.1",
     "DRAKO 8x19 W (210 TF) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x19 S (210 TFS)", "drako_210_tfs.json", "drako_210tfs", [0], "s.1",
     "DRAKO 8x19 S (210 TFS) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x19 S (8x19 S-FC)", "drako_8x19_s_fc.json", "drako_8x19_s_fc", [0], "s.1",
     "DRAKO 8x19 S (8x19 S-FC) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x19 W (8x19 W-FC)", "drako_8x19_w_fc.json", "drako_8x19_w_fc", [0], "s.1",
     "DRAKO 8x19 W (8x19 W-FC) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x25 F (8x25 F-FC)", "drako_8x25_f_fc.json", "drako_8x25_f_fc", [0], "s.1",
     "DRAKO 8x25 F (8x25 F-FC) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "6x19 S (Regülatör)", "drako_reg_6x19_s_iwrc.json", "drako_regulator", [0], "s.1",
     "DRAKO 6x19 S (Regülatör) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x19 S (Regülatör)", "drako_reg_8x19_s_fc.json", "drako_regulator", [0], "s.1",
     "DRAKO 8x19 S (Regülatör) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "6x19 S (Regülatör, elyaf öz)", "drako_reg_6x19_s_fc.json", "drako_regulator", [0], "s.1",
     "DRAKO 6x19 S (Regülatör, elyaf öz) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "6x19 W (Regülatör, elyaf öz)", "drako_reg_6x19_w_fc.json", "drako_regulator", [0], "s.1",
     "DRAKO 6x19 W (Regülatör, elyaf öz) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "6x25 F (180 B)", "drako_180_b_6x25_f.json", "drako_180b", [0], "s.1",
     "DRAKO 6x25 F (180 B) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "6x36 WS (180 B)", "drako_180_b_6x36_ws.json", "drako_180b", [0], "s.1",
     "DRAKO 6x36 WS (180 B) — genel bakış ve çelik halat teknik tablosu"),
    ("rope", "DRAKO", "8x25 F (200 B)", "drako_200_b.json", "drako_200b", [0], "s.1",
     "DRAKO 8x25 F (200 B) — genel bakış ve çelik halat teknik tablosu"),
    # ------------------------------------------------------- SEW X..e /HC
    ...
    def evidenced(model: str, item: dict) -> bool:
        ...
        for field in ("diameter_mm", "frame_size"):
            ...
            if isinstance(val, (int, float)):
                # Ondalık ayıracı sayfadan sayfaya değişir: aynı üreticinin
                # föylerinde çap kimi yerde "25.4", kimi yerde "4,8" basılır
                # (UNION FLEX X-9 ↔ 3xK7). İki yazımı da kanıt sayarız; yoksa
                # sayfa gerçekten doğruyken doğrulanamamış görünürdü.
                shown = fmt_num(val)
                if shown in words or shown.replace(".", ",") in words:
                    return True
