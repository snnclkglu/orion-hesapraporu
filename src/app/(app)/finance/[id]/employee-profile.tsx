...
// götürürdü.
//
// Maaş satırlarının AVRO karşılığı DÖNEMİN kurundan çıkar (`fin_periods`),
                ...
                return (
                  <TableRow key={r.id}>
                    ...
                    <TableCell className="text-right">
                      ...
                      <a
                        href={`/finance/bordro?kisi=${employee.id}&donem=${r.period}`}
                        target="_blank"
...
function EmploymentDialog({
  ...
  // asıl kural veritabanındaki `fin_employment_open_key` tekil indeksidir ve
