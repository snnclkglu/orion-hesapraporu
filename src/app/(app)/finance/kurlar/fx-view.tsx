...
// `lib/finance/fx.ts` başlığındadır — ekran o gerekçeyi kullanıcıya da anlatır.
...
export function FxView({
  ...
  function secDonem(period: string) {
    router.replace(`/finance/kurlar?ay=${period}`, { scroll: false });
  }
  ...
  // ————————————————————————————————————————————————————————— dönem kaydı
  //
  // `fin_periods` maaş dönemine DONMUŞ kuru taşır (AGENTS md. 16: kur satırın
          ...
          <TableHeader>
            <TableRow className="bg-muted/50 hover:bg-muted/50">
              ...
              <TableHead
                ...
                title="Maaş döneminde donmuş kur (fin_periods) — ortalamadan bağımsızdır"
              >
                Dönem Kaydı
              </TableHead>
            </TableRow>
