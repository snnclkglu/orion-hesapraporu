...
export type FinanceActionResult = { error?: string; ok?: boolean; id?: string };
...
/**
 * DÖNEM AYARLARI — kur ve ay düzeyindeki izin/rapor saatleri.
 *
 * Kur SATIRIN KENDİNDEDİR (AGENTS md. 16): merkezî kur tablosundan
 * okunsaydı, tablo tazelendiğinde geçmiş ayların avro karşılığı da değişirdi.
 * Ekran ortalamayı ÖNERİR, kullanıcı onaylar, değer donar.
 */
