...
/**
 * KATLANABİLİR BÖLÜM ARTIK BURADA DEĞİL: `Katlama`, `KatlaDugmesi`, `Bolum` ve
 * `MiniDugme` `@/components/katlanir-bolum`e taşındı. Sebep ikinci bir
 * kullanıcının doğmasıdır (hesap raporundaki Ağırlık Dökümü penceresi); aynı
 * katlama davranışının ikinci bir kopyası, bu dosyanın başındaki "aynı şekil,
 * ayrı sahip" notunun uyardığı ayrışma olurdu (değişmez md. 8). Gövdeler
 * DEĞİŞMEDEN taşındı ve buradan yeniden dışa verilir — maliyet editörünün
 * çağrı yerleri tek dosya görmeye devam eder.
 */
export {
  Bolum,
  KatlaDugmesi,
  MiniDugme,
  type Katlama,
} from "@/components/katlanir-bolum";
