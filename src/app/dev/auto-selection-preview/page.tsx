...
export default async function AutoSelectionPreview({ searchParams }: { searchParams: Promise<{ readonly?: string; context?: string }> }) {
  ...
  return <main className="flex h-dvh min-h-0 flex-col gap-3 p-3">
    ...
    <div className="min-h-0 flex-1"><RevisionEditor projectId="dev" revisionId="dev" readOnly={params.readonly === "1"} initial={{ ...NEW_WORK_TEMPLATE, specs: { ...NEW_WORK_TEMPLATE.specs, hoistBrakeType: "Eldro Fren" } }}
