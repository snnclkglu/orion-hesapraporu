// Sadece development: Finans ekranlarını auth OLMADAN görsel test etmek için.
...
import { FinanceNav } from "@/app/(app)/finance/finance-nav";
import { PersonnelTable } from "@/app/(app)/finance/personnel-table";
import { PayrollBoard } from "@/app/(app)/finance/maas/payroll-board";
import { SummaryView } from "@/app/(app)/finance/ozet/summary-view";
import { FxView } from "@/app/(app)/finance/kurlar/fx-view";
import { PerDiemTable } from "@/app/(app)/finance/harcirah/per-diem-table";
import { EmployeeProfile } from "@/app/(app)/finance/[id]/employee-profile";
import type {
  DocumentRow,
  EmployeeRow,
  FxMonthlyRow,
  ...
  PerDiemRow,
  PeriodRow,
} from "@/app/(app)/finance/schema";
import { fazlaMesaiTutari } from "@/lib/finance/payroll";
  ...
  return (
    <div className="mx-auto grid max-w-none gap-10 p-4 lg:p-8">
      <header className="grid gap-1">
        ...
        <h1 className="text-2xl font-semibold">Finans — Ekran Önizlemesi</h1>
