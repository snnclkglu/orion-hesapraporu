...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        // Marka kontrol yüksekliği 40px; grup 36px kalınca içindeki `Input`
        // (h-10) kabından 2px taşıyordu.
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        // Yükseklik GRUPTAN gelir: grup küçültüldüğünde (ör. komut paleti
        // arama kutusu) denetim de onunla birlikte küçülür, taşmaz.
