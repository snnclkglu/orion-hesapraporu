...
export const HOIST_INPUT_FIELDS: FieldDef<HoistInputs>[] = [
  ...
  { key: "drumWeldAllowable", label: "Tambur kaynağı izin gerilmesi", unit: "kg/cm²", type: "number", excelCell: "L101" },
  { key: "shaftWeldThicknessCm", label: "Mil kaynak kalınlığı", unit: "cm", type: "number", excelCell: "L115" },
  { key: "shaftWeldAllowable", label: "Mil kaynağı izin gerilmesi", unit: "kg/cm²", type: "number", excelCell: "L117" },
