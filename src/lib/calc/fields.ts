...
export const SPEC_FIELDS: FieldDef<TechnicalSpecs>[] = [
  ...
  { key: "hoistMechanismClass", label: "Kaldırma mekanizma sınıfı", type: "select", options: MECHANISM_CLASSES, excelCell: "P12", femTable: "gammaM" },
  ...
  { key: "bridgeMechanismClass", label: "Köprü mekanizma sınıfı", type: "select", options: MECHANISM_CLASSES, excelCell: "P15", femTable: "gammaM" },
  ...
  { key: "trolleyMechanismClass", label: "Araba mekanizma sınıfı", type: "select", options: MECHANISM_CLASSES, excelCell: "P18", femTable: "gammaM" },
