...
export const GIRDER_INPUT_FIELDS: FieldDef<GirderInputs>[] = [
  ...
  { key: "wheelContactHMm", label: "Teker basıncı yayılım yüksekliği h", unit: "mm", type: "number", excelCell: "D264" },
  { key: "wheelContactTMm", label: "Teker basıncı taşıyan sac (ray T-profil) kalınlığı t", unit: "mm", type: "number", excelCell: "D265" },
