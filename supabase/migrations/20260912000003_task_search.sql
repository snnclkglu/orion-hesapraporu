-- Arama Türkçe harfleri katlar; API kaynak referansını doğrudan arayabilir.
create function public.task_search_fold(value text) returns text language sql immutable parallel safe as $$ select lower(translate(value,'ÇĞİIÖŞÜçğıöşü','CGIIOSUcgiosu')) $$;
